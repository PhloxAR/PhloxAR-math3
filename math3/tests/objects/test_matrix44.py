...
class test_object_matrix44(unittest.TestCase):
    ...
    def test_imports(self):
        import math3
        math3.Matrix4()
        math3.matrix44.Matrix44()
        math3.objects.matrix4.Matrix4()

        from math3 import Matrix4
        from math3.objects import Matrix4
        from math3.objects.matrix4 import Matrix4
    ...
    def test_create(self):
        ...
        m = Matrix4(np.arange(self._size))
        self.assertEqual(m.shape, self._shape)
    ...
    def test_create_from_inverse_quaternion(self):
        ...
        m = Matrix4.from_inverse_of_quaternion(q)
